...
--
-- @tparam table tbl The table to modify
-- @tparam integer s Start index
-- @tparam integer e End index (inclusive)
-- @treturn table A new table with the portion reversed
...
--
-- CODE SMELL: Do we ever call it with a `base_level` other than 0?
--
-- @tparam table line Something
-- @tparam integer base_level Some level
...
--
-- @tparam table nodelist List of nodes
...
--
-- It keeps track of the owner of each character, i.e., from which node
-- each character came from, and its position in that node.
--
-- @tparam table nl Nodelist
-- @treturn table Owners table
-- @treturn table Text table
...
--
-- @tparam SILE.types.node.unshaped n Node to split
-- @tparam integer splitstart Start position
-- @tparam integer p Position
-- @treturn SILE.types.node.unshaped First part
-- @treturn SILE.types.node.unshaped Second part
...
--
-- @tparam table nl List of nodes
-- @tparam string direction Base direction ("LTR" or "RTL")
-- @treturn table Nodelist split into runs
...
--
-- @tparam table nl List of shaped nodes
-- @tparam string direction Base direction ("LTR" or "RTL")
-- @treturn table Reordered list of nodes
