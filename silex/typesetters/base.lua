--- Modified resilient base typesetter class.
-- Also known as "sile·nt" (SILE New Typesetter experiment for re·sil·ient).
--
...
-- TEMPORARY WARNING
-- Just to be sure when we are using the new typesetter, as things may be unstable for now.
SU.warn("---- You are using the new experimental typesetter ('sile·nt') for re·sil·ient ----")
