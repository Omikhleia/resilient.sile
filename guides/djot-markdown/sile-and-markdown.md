...
![The **resilient.sile** ecosystem (simplified).](./markdown-sile-schema.dot){width="90%"}
...
CSV files are also supported, when the **piecharts.sile** optional collection is properly installed, and are rendered as pie charts.
...
[^markdown-ean13-assume]: The package is part of the **barcodes.sile** collection, installed by default.
