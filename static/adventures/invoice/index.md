...
Title:           Invoice EX-2025-1
Author:          The Sherlock Holmes Company
...
> The PDF would also contain a buyer logo image, if we had declared one in our invoice. As I extend these modules, it will also eventually include the "style" file, when one is used to customize the invoice appearance.
